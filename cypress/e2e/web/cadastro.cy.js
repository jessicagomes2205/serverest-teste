...
describe('Funcionalidade: Cadastro', () => {
  ...
  it.skip('Deve fazer o cadastro de Usuário Admin com sucesso, usando Date Now', () => {
  ...
  it.skip('Deve validar mensagem de campo (Nome) obrigatório', () => {
    var email = 'jessica' + Date.now() + '@gmail.com';
  ...
  it.skip('Deve fazer o cadastro de Usuário Comum com sucesso, usando Faker', () => {
